...
import com.scnuwang.ActivityTracker;
import com.scnuwang.FlowContext;
import com.scnuwang.HttpFilters;
import com.scnuwang.HttpFiltersAdapter;
...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
    ...
    private ConnectionState doReadHTTPInitial(HttpRequest httpRequest) {
        ...
        if (clientToProxyFilterResponse != null) {
            ...
            // Connection: close 或者response 为空时断开连接
        ...
        // 将通过主机+端口跟踪所有ProxyToServerConnections。
