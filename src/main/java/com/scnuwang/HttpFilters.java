...
import com.scnuwang.impl.ProxyUtils;
 ...
 * 每个请求都会创建一个HttpFilters，因此这些对象可以是有状态的
 * </p>
 * 
 * <p>
...
public interface HttpFilters {
     ...
     * FullHttpResponse.
     *  响应需要有响应机制：body，Transfer-Encoding，Content-Length，Connection: close 推荐返回FullHttpResponse对象
